...
public class TicketHistory implements Serializable {
    ...
    public String toString() {
        return "TicketHistory{" +
                ...
                ", ensurerName='" + ensurerName + '\'' +
                ", ensurerAddress='" + ensurerAddress + '\'' +
                ", ensureDate=" + ensureDate +
                ", acceptancerUser='" + acceptancerUser + '\'' +
                ", acceptancerAccount='" + acceptancerAccount + '\'' +
                ", acceptancerBank='" + acceptancerBank + '\'' +
                ", acceptancerBankNum='" + acceptancerBankNum + '\'' +
                ", giveWay='" + giveWay + '\'' +
                ", contractNumber='" + contractNumber + '\'' +
                ", issuePromise='" + issuePromise + '\'' +
                ", acceptancerAcceptance='" + acceptancerAcceptance + '\'' +
                ", mortgage='" + mortgage + '\'' +
                ", userId=" + userId +
                ", lockState='" + lockState + '\'' +
                ", receiveId=" + receiveId +
